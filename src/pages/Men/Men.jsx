...
const Men = () => {
  const categories = Object.values(menCategories);
      ...
      <div className="container-custom py-6">
        ...
        >
          <h1 className="text-3xl md:text-4xl font-bold text-black mb-1">
            Men's <span className="text-purple-600">Collection</span>
          </h1>
          <p className="text-gray-600">Explore our premium men's fashion categories</p>
